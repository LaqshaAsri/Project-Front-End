...
class Donasi extends React.Component {
  ...
  handleSubmit = (e) => {
    ...
    const nominalAngka = parseInt(this.state.nominal, 10);
    ...
    this.setState(
      (prev) => ({
        totalDonasi: prev.totalDonasi + nominalAngka,
        nominal: "",
      }),
      () => {
          ...
          <main className="page-content bodyy">
            <div className="container mt-4">
              <div className="guide-box">
                ...
                <h3 className="text-center mb-3">Donasi Terkumpul (Rp {this.state.totalDonasi.toLocaleString("id-ID")})</h3>
                ...
                <div className="mt-4">
                  <form onSubmit={this.handleSubmit}>
                    ...
                    <input type="number" className="form-control" value={this.state.nominal} onChange={this.handleChange} placeholder="" required />
