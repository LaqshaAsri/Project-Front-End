...
const ProfileDetail = () => {
  ...
  useEffect(() => {
    if (person) {
      document.title = `Profil Detail - ${person.name}`;
    }
  });
  ...
  if (!person) {
    return (
      <div className="container text-center" style={{ marginTop: "100px" }}>
        ...
        <Link to="/tim" className="btn btn-primary mt-3">
          Kembali ke Tim
        </Link>
      </div>
    );
          ...
          <div className="container">
            <div className="row align-items-center">
              ...
              <div className="col-md-6 text-center text-md-end mt-4 mt-md-0">
                ...
                <Link to="/kontak" className="btn fw-bold rounded-pill px-4 py-2" style={{ backgroundColor: "#86bef6ff", color: "#3c6cefff", border: "none" }}>
                  {person.buttonText}
                </Link>
              </div>
            </div>
        ...
        <section className="container my-5 content-section">
          ...
          <div className="tab-content profile-tab-content p-4 shadow-sm rounded bg-white">
            <div className="tab-pane fade show active" id="tentang" role="tabpanel">
              <h3 className="section-title" style={{ color: person.accentColor }}>
                Filosofi Pelayanan
              </h3>
