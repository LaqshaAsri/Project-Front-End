            ...
            <div className="container">
              <div className="row align-items-center">
                ...
                <div className="col-md-6 text-center text-md-end mt-4 mt-md-0">
                  ...
                  <Link to="/kontak" className="btn fw-bold rounded-pill px-4 py-2" style={{ backgroundColor: "#86bef6ff", color: "#3c6cefff", border: "none", boxShadow: "0 4px 15px rgba(0,0,0,0.1)", textDecoration: "none" }}>
